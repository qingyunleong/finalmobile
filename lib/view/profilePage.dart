...
import 'package:final_mobile/view/loginpage.dart';
...
class _ProfilePageState extends State<ProfilePage> {
                            ...
                            child: Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: ClipOval(
                                  child: Image.network(
                                    Config.server +
                                        '/mobile_mytutor/assets/profile/${widget.user.email}.jpg' +
                                        "?v=$val",
  ...
  void _updateProfileImage(image) {
    ...
    http.post(
        Uri.parse(Config.server + "/mobile_mytutor/php/update_profile.php"),
        body: {
